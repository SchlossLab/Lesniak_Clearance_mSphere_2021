...
treatment_list <- list('clinda', 'cef', 'metro', 'strep', c('cef', 'metro', 'strep'), 
		c('clinda', 'cef', 'strep'), 
...
all_diff_abund <- differential_abundance_plot(test_output_df, paste(treatment_list[[7]], collapse = '_'))
...
differential_abundance_plot(test_change_cleared_df, treatment_list[[6]])
differential_abundance_plot(test_change_cleared_df, treatment_list[[7]])
...
get_first_order('cef', '#F8766D')
get_first_order('clinda', '#00BA38')
get_first_order('metro', 'purple')
