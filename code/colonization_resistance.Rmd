...
The antibiotic treamtent seems to have fairly consistent results
At the phylum level
  ...
  For the mid dose (0.3), 
    ...
    the mice uninfected had the least changed communities, a slight increase in Verrucomicrobia at day 0 and back to inital at the endpoint
    the mice that clear have a large increase in Firmiutes in half the mice at day 0, but by the endpooint all look like day 0 cef 0.1 (increased Verrucomicrobia, and some proteobacteria)
  ...
  For the high dose (0.5)
    ...
    the endpint colonization communities either stay firmicutes dominant or return to a bacteriodetes dominant with Verrucomicrobia (20%)
At the genus level, we explore the differences between communties that look similar at the phylum level but result in different endpoint colonization
  For the mice that clear the infection (9 mice with 0.3 dose)
